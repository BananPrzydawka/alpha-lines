"""Shared Modal image and output volume for the Rust benchmark."""
...
image = (
    ...
    # Modal auto-mounts the entrypoint at /root/modal_mcts.py; its sibling
    # modules live in our explicit /root/python mount.
    .env({"PYTHONPATH": "/root/python"})
    .add_local_dir(project_dir / "python", remote_path="/root/python", ignore=["__pycache__/"])
